...
//int main() {
//    string str = readAllFile(R"(D:\Compilers Principles\src\LL1Grammar\grammar.txt)");
////    string str = "E -> E + T | T\nT -> F | T * F\nF -> i | ( E )";
////    string str = "A -> b a | a\nB -> A b | A c | d\nX -> Z";
//
////    cout << str;
...
//    cout << "------------first集合------------\n";
//    gr.print_first();
////    cout << gr.start_word << "________\n";
//    gr.follow_get();
//    cout << "------------follow集合------------\n";
//    gr.print_follow();
//
////    bool grammar_ll = gr.is_ll();
////    if (grammar_ll) {
////        cout << "------------yes------------\n";
////    } else cout << "------------no------------\n";
//    gr.create_forecast_table();
////    cout << "------------预测表------------\n";
////    gr.print_forecast_table();
//
//    auto test_string = readAllFile(R"(D:\Compilers Principles\src\LL1Grammar\code.txt)");
//    vector<string> test_vector_string = split_string(test_string, '\n');
//    cout << "------------分析结果------------\n";
//    bool code_accepted = true;
//    for (auto row = 0; row < test_vector_string.size(); ++row) {
//        vector<string> row_code = split_string(test_vector_string.at(row), ' ');
//        bool flag = gr.analyse_stack(row_code);
//        if (flag) cout << "------the " << row << "row code accepted!!!!------\n";
//        else {
//            cout << "------the " << row << "row code unaccepted!!!!------\n";
//            code_accepted = false;
//        }
//    }
//    if (code_accepted) {
//        cout << "------the code accepted!!!!------\n";
//    } else
//        cout << "------the code unaccepted!!!!------\n";
//
//
////    vector<string> test_vector_string = {"(", "i", "+", "i", ")", "*", "i"};
////    bool flag = gr.analyse_stack(test_vector_string);
////    cout << "------------分析结果------------\n";
////    if (flag) cout << "------accepted!!!!------\n";
////    else cout << "------unaccepted!!!!------\n";
////    cout << "VN:--------\n";
////    for (const auto &x: gr.VN) {
////        cout << x << "  ";
////    }
////    cout << "\nVT:--------\n";
////    for (const auto &x: gr.VT) {
////        cout << x << "  ";
////    }
////    gr.Print_gra();
////    cout << "start_word:" << gr.start_word << "\n";
//    return 0;
//}
